#pragma checksum "F:\PSOFT\Psoft\Psoft\Pages\BlankBOQ.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "15ecdeb4e805615133f0bc9c091ac4463e623673"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"15ecdeb4e805615133f0bc9c091ac4463e623673", @"/Pages/BlankBOQ.cshtml")]
		...
		<div class=""table-editable"">
			...
			<table class=""table table-bordered table-responsive-md table-striped text-center"" id=""table"">
				...
				<thead>
					...
					");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "15ecdeb4e805615133f0bc9c091ac4463e6236734746", async() => {
					...
					<tr>
						...
						<td class=""pt-3-half"">
							...
							<span class=""table-down"">
								<a href=""#!"" class=""indigo-text""><i class=""fas fa-long-arrow-alt-down"" aria-hidden=""true""><");
            WriteLiteral(@"/i></a>
							</span>
						</td>
						<td>
		...
		$(function () {
			...
			$('#b1').click(function () {
				...
				$('#table tr').each(function (i) {
					...
					$('#table tr ').find('#totalcost'");
            WriteLiteral(@").text(Totalcost.toFixed(2));
...
<tr class=""hide"">
            ...
            WriteLiteral(@"nger btn-rounded btn-sm my-0"">
										Remove
									</button>
								</span>
							</td>
...
`;
		...
		");
            WriteLiteral(@"	$($rows.shift()).find('th:not(:empty)').each(function () { headers.push($(this).text().toLowerCase()); }); // Turn all existing rows into a loopablearray
			$rows.each(function () {
	...
	<script>
		function createPDF() {
			...
			win.document.write('<title>P");
            WriteLiteral(@"rofile</title>');   // <title> FOR PDF HEADER.
