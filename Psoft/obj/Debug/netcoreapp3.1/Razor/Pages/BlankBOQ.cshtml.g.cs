#pragma checksum "F:\PSOFT\Psoft\Psoft\Pages\BlankBOQ.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "77efe98de358009ff523165f114b0fec9b73ad5a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"77efe98de358009ff523165f114b0fec9b73ad5a", @"/Pages/BlankBOQ.cshtml")]
		...
		<div class=""table-editable"">
			...
			<table class=""table table-bordered table-responsive-md table-striped text-center"" id=""table"">
				...
				<thead>
					...
					");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "77efe98de358009ff523165f114b0fec9b73ad5a4746", async() => {
					...
					<tr>
						...
						<td class=""pt-3-half"">
							...
							<span class=""table-down"">
								<a href=""#!"" class=""indigo-text""><i class=""fas fa-long-arrow-alt-down""");
		...
		$(function () {
			...
			$('#b1').click(function () {
				...
				$('#table tr').each(function (i) {
					...
					$('#table tr");
            WriteLiteral(@" ').find('#totalcost').text(Totalcost.toFixed(2));
...
<tr class=""hide"">
							...
							<td>
								<span class=""table-remove"">
									<button type=""butt");
            WriteLiteral(@"on"" class=""btn btn-danger btn-rounded btn-sm my-0"">
										Remove
									</button>
								</span>
							</td>
...
`;
		...
		$BTN.on('click', () => {
			const $rows = $tableID.find('tr:not(:hidden)'); const headers = []; const data = []; // Get the headers(add special h");
            WriteLiteral(@"eader logic here)
	...
	<script>
		function createPDF() {
			...
			win.doc");
            WriteLiteral(@"ument.write('<title>Profile</title>');   // <title> FOR PDF HEADER.
