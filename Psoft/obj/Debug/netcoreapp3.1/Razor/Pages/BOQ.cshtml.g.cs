#pragma checksum "F:\ITI\gradution project\Final submission\PSOFT\Psoft\Pages\BOQ.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e75f23e1c8815e1d8da2b5ef5dafe12a5e813346"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e75f23e1c8815e1d8da2b5ef5dafe12a5e813346", @"/Pages/BOQ.cshtml")]
		...
		<div class=""table-editable"">
			...
			<table class=""table table-bordered table-responsive-md table-striped text-center"" id=""table"">
				...
				<thead>
					...
					");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e75f23e1c8815e1d8da2b5ef5dafe12a5e8133465179", async() => {
...
");
#nullable restore
#line 56 "F:\ITI\gradution project\Final submission\PSOFT\Psoft\Pages\BOQ.cshtml"
...
#nullable restore
#line 62 "F:\ITI\gradution project\Final submission\PSOFT\Psoft\Pages\BOQ.cshtml"
...
#nullable disable
            WriteLiteral("</th>\r\n\r\n\t\t\t\t\t\t\t<th>");
#nullable restore
#line 64 "F:\ITI\gradution project\Final submission\PSOFT\Psoft\Pages\BOQ.cshtml"
                           Write(item.Unit);
...
");
#nullable restore
#line 86 "F:\ITI\gradution project\Final submission\PSOFT\Psoft\Pages\BOQ.cshtml"
...
`;
		...
		$('.table-add').on('click', 'i', () => {
			const $clone = $tableID.find('tbodyt");
            WriteLiteral(@"r').last().clone(true).removeClass('hide table-line'); if ($tableID.find('tbody tr').length >= 0) {
		...
		$BTN.on('click', () => {
			...
			$rows.each(function () {
				const $t");
            WriteLiteral(@"d = $(this).find('td'); const h = {}; // Use the headers from earlier to name our hash keys headers.
				forEach((header, i) => {
	...
	<script>
		function createPDF() {
			...
			win");
            WriteLiteral(@".document.write(sTable);         // THE TABLE CONTENTS INSIDE THE BODY TAG.
