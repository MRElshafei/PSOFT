#pragma checksum "E:\PSOFT FINAL\PSOFT\Psoft\Pages\BOQ.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9abe65a4403631bb45675a491371306a094a2564"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9abe65a4403631bb45675a491371306a094a2564", @"/Pages/BOQ.cshtml")]
...
<div class=""card"">
    ...
    <h6 style=""color:steelblue"" class=""card-header text-center font-weight-bold text-uppercase py-4"">
        ");
#nullable restore
#line 26 "E:\PSOFT FINAL\PSOFT\Psoft\Pages\BOQ.cshtml"
        ...
        <div class=""table-editable"">
            ...
            <table class=""table table-bordered table-responsive-md table-striped text-center"" id=""table"">
                ...
                <thead>
                    ...
                    &nbsp;
                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9abe65a4403631bb45675a491371306a094a25645235", async() => {
...
");
#nullable restore
#line 57 "E:\PSOFT FINAL\PSOFT\Psoft\Pages\BOQ.cshtml"
...
#nullable restore
#line 63 "E:\PSOFT FINAL\PSOFT\Psoft\Pages\BOQ.cshtml"
...
#nullable disable
            WriteLiteral("</th>\r\n\r\n                            <th>");
#nullable restore
#line 65 "E:\PSOFT FINAL\PSOFT\Psoft\Pages\BOQ.cshtml"
                           Write(item.Unit);
...
#nullable restore
#line 66 "E:\PSOFT FINAL\PSOFT\Psoft\Pages\BOQ.cshtml"
...
#nullable restore
#line 67 "E:\PSOFT FINAL\PSOFT\Psoft\Pages\BOQ.cshtml"
                                                      Write(item.Quantity);
...
#nullable restore
#line 87 "E:\PSOFT FINAL\PSOFT\Psoft\Pages\BOQ.cshtml"
...
<tr class=""hide"">
                                                                ...
                                                                <td class=""pt-3-half"" contenteditable=""true""></td>
                                                                    ...
                                                                    <td class=""value2"" contenteditable=""true"">0</td>
                                                                          ...
                                                                          <td class=""pt-3-half"">
                                                         ");
            WriteLiteral(@"                   <span class=""table-up""><a href=""#!"" class=""indigo-text""><i class=""fas fa-long-arrow-alt-up"" aria-hidden=""true""></i></a></span>
...
`;
        ...
        $BTN.on('click', () => {
            const $rows");
            WriteLiteral(@" = $tableID.find('tr:not(:hidden)'); const headers = []; const data = []; // Get the headers(add special header logic here)
    ...
    <script>
        function export2csv() {
            ...
            for (const row of rows) {
                const rowData = [];
                for (const [index, column] ");
            WriteLiteral(@"of row.querySelectorAll(""th, td"").entries()) {
    ...
    <script>
        function createPDF() {
            ...
            var style = ""<style>"";
            styl");
            WriteLiteral(@"e = style + ""table {width: 100%;font: 17px Calibri;}"";
